...
<div id="cartRender" data-amount="<?= Yii::$container->get('common\models\Cart')->getAmount(); ?>">
    ...
    <div class="cartItem">
        ...
        <div class="itemDesc">
            ...
            <div class="itemQty"><span class="circle bordered-red"><?= $quantity; ?></span> <?= $data->price; ?> <span class="icon-rur"></span></div>
            <a class="btn bordered-red" href="<?= Url::to(['cart/index']); ?>">Открыть корзину</a>
        </div>
    </div>
